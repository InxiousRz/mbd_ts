...
class frame_main(wx.Frame):
    def __init__(self, parent):
        ...
        self.m_staticText1 = wx.StaticText(self.m_panel1, wx.ID_ANY,
                                           u"Device Communication Data",
        ...
        self.m_dataViewListColumn1 = self.dv_devicecomms.AppendTextColumn(
            u"No", wx.DATAVIEW_CELL_INERT, -1, wx.ALIGN_LEFT,
            wx.DATAVIEW_COL_RESIZABLE)
        self.m_dataViewListColumn2 = self.dv_devicecomms.AppendTextColumn(
            u"Device Name", wx.DATAVIEW_CELL_INERT, -1, wx.ALIGN_LEFT,
            wx.DATAVIEW_COL_RESIZABLE)
        self.m_dataViewListColumn3 = self.dv_devicecomms.AppendTextColumn(
            u"Communication", wx.DATAVIEW_CELL_INERT, -1, wx.ALIGN_LEFT,
            wx.DATAVIEW_COL_RESIZABLE)
        self.m_dataViewListColumn13 = self.dv_devicecomms.AppendTextColumn(
            u"devcommid", wx.DATAVIEW_CELL_INERT, -1, wx.ALIGN_LEFT,
            wx.DATAVIEW_COL_HIDDEN)
        self.m_dataViewListColumn20 = self.dv_devicecomms.AppendTextColumn(
            u"deviceattachdetailid", wx.DATAVIEW_CELL_INERT, -1, wx.ALIGN_LEFT,
            wx.DATAVIEW_COL_RESIZABLE)
        fgSizer2.Add(self.dv_devicecomms, 0, wx.ALL, 5)

        gSizer1 = wx.GridSizer(0, 3, 0, 0)

        self.cmd_editmaindata = wx.Button(self.m_panel1, wx.ID_ANY,
                                          u"Edit Communication",
                                          wx.DefaultPosition, wx.DefaultSize,
                                          0)
        gSizer1.Add(
            self.cmd_editmaindata, 0,
            wx.ALL | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 5)

        self.cmd_refreshmaindata = wx.Button(self.m_panel1, wx.ID_ANY,
                                             u"Refresh Data",
                                             wx.DefaultPosition,
                                             wx.DefaultSize, 0)
        gSizer1.Add(
            self.cmd_refreshmaindata, 0,
            wx.ALL | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 5)

        self.cmd_exit = wx.Button(self.m_panel1, wx.ID_ANY, u"Exit",
        ...
        fgSizer1.Add(
            self.m_panel1, 1, wx.EXPAND | wx.ALL | wx.ALIGN_CENTER_HORIZONTAL
